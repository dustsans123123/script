...
local SettingsTab = Window:AddTab({Title = "Setting"});
local LocalPlayerTab = Window:AddTab({Title = "Local Player"});
local HoldTab = Window:AddTab({Title = "Hold Skill"});
if World3 then
	SeaTab = Window:AddTab({Title = "Sea Event"});
	SettingSeaTab = Window:AddTab({Title = "Setting Sea"});
end;
if World2 or World3 then
	SeaStackTab = Window:AddTab({Title = "Stack Sea"});
end;
if World3 then
	CraftTab = Window:AddTab({Title = "Crafts"});
	DragonDojoTab = Window:AddTab({Title = "Dragon Dojo"});
end;
local StatsTab = Window:AddTab({Title = "Stats Weapon"});
if World3 or World2 then
	RaceV4Tab = Window:AddTab({Title = "Race V4"});
end;
local CombatTab = Window:AddTab({Title = "Combat"});
if World2 or World3 then
	RaidTab = Window:AddTab({Title = "Raid"});
end;
local EspTab = Window:AddTab({Title = "Esp"});
local TeleportTab = Window:AddTab({Title = "Teleport"});
local ShopTab = Window:AddTab({Title = "Shop"});
local FruitTab = Window:AddTab({Title = "Devil Fruit"});
local MiscTab = Window:AddTab({Title = "Misc"});
local ServTab = Window:AddTab({Title = "Server"});
_G.Settings = {
	Main = {
		["Select Weapon"] = "Melee",
		["Farm Mode"] = "Normal",
...
MainTab:AddParagraph({Title = "── Main ──"})
...
MainTab:AddButton({Title = "Copy Tik Tok Link", Callback = function()
	setclipboard("https://www.tiktok.com/@huyscriptth?_r=1&_t=ZS-92qnNEgEjZZ");
	Fluent:Notify({Title = "Thông báo", Content = "Copied!", Duration = 3});
end});
MainTab:AddParagraph({Title = "── Level Farm ──"})
local WeaponList = {
	"Melee",
	"Sword",
	"Fruit"
};
MainTab:AddDropdown("D1", {Title = "Choose Weapon", Values = WeaponList, Default = _G.Settings.Main["Select Weapon"], Callback = function(value)
...
MainTab:AddDropdown("D2", {Title = "Choose Farm Mode", Values = ListF, Default = _G.Settings.Main["Farm Mode"], Callback = function(value)
	_G.Settings.Main["Farm Mode"] = value;
	(getgenv()).SaveSetting();
end});
MainTab:AddToggle("TG1", {Title = "Auto Farm", Default = _G.Settings.Main["Auto Farm"], Callback = function(value)
...
if World1 then
	MainTab:AddToggle("TG2", {Title = "Auto Farm Fast", Default = _G.Settings.Main["Auto Farm Fast"], Callback = function(value)
...
MainTab:AddParagraph({Title = "── Mastery Farm ──"})
if World3 then
	ListMasteryMethod = {
		"Quest",
		"No Quest",
...
MainTab:AddDropdown("D3", {Title = "Choose Mode", Values = ListMasteryMethod, Default = _G.Settings.Main["Selected Mastery Mode"], Callback = function(value)
	_G.Settings.Main["Selected Mastery Mode"] = value;
	(getgenv()).SaveSetting();
end});
MainTab:AddToggle("TG3", {Title = "Auto Farm Fruit Mastery", Default = _G.Settings.Main["Auto Farm Fruit Mastery"], Callback = function(value)
	_G.Settings.Main["Auto Farm Fruit Mastery"] = value;
	StopTween(_G.Settings.Main["Auto Farm Fruit Mastery"]);
	(getgenv()).SaveSetting();
end});
MainTab:AddToggle("TG4", {Title = "Auto Farm Gun Mastery", Default = _G.Settings.Main["Auto Farm Gun Mastery"], Callback = function(value)
...
MainTab:AddDropdown("D4", {Title = "Choose Sword", Values = SwordList, Default = _G.Settings.Main["Selected Mastery Sword"], Callback = function(value)
...
MainTab:AddToggle("TG5", {Title = "Auto Farm Sword Mastery", Default = _G.Settings.Main["Auto Farm Sword Mastery"], Callback = function(value)
...
MainTab:AddParagraph({Title = "── Mob Farm ──"})
MainTab:AddDropdown("D5", {Title = "Choose Mob", Values = tableMon, Default = _G.Settings.Main["Selected Mob"], Callback = function(value)
	_G.Settings.Main["Selected Mob"] = value;
	(getgenv()).SaveSetting();
end});
MainTab:AddToggle("TG6", {Title = "Auto Farm Mob", Default = _G.Settings.Main["Auto Farm Mob"], Callback = function(value)
...
MainTab:AddParagraph({Title = "── Boss Farm ──"})
...
MainTab:AddDropdown("D6", {Title = "Choose Boss", Values = tableBoss, Default = _G.Settings.Main["Selected Boss"], Callback = function(value)
	_G.Settings.Main["Selected Boss"] = value;
	(getgenv()).SaveSetting();
end});
MainTab:AddToggle("TG7", {Title = "Auto Farm Boss", Default = _G.Settings.Main["Auto Farm Boss"], Callback = function(value)
...
MainTab:AddToggle("TG8", {Title = "Auto Farm All Boss", Default = _G.Settings.Main["Auto Farm All Boss"], Callback = function(value)
...
if World3 then
	FarmTab:AddParagraph({Title = "── Elite Hunter ──"})
	...
	FarmTab:AddToggle("TG9", {Title = "Auto Elite Hunter", Default = _G.Settings.Farm["Auto Elite Hunter"], Callback = function(value)
		_G.Settings.Farm["Auto Elite Hunter"] = value;
		StopTween(_G.Settings.Farm["Auto Elite Hunter"]);
		(getgenv()).SaveSetting();
	end});
	FarmTab:AddToggle("TG10", {Title = "Auto Elite Hunter Hop", Default = _G.Settings.Farm["Auto Elite Hunter Hop"], Callback = function(value)
	...
	FarmTab:AddButton({Title = "Check Progress", Callback = function()
		Fluent:Notify({Title = "Elite Hunter", Content = "Progress : " .. tostring((game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("EliteHunter", "Progress")), Duration = 3});
	end});
	...
	FarmTab:AddParagraph({Title = "── Bone Farm ──"})
	local ListB = {
		"Quest",
		"No Quest"
	};
	FarmTab:AddDropdown("D7", {Title = "Choose Mode", Values = ListB, Default = _G.Settings.Farm["Selected Bone Farm Mode"], Callback = function(value)
	...
	local BoneFarm = (FarmTab:AddToggle("TG11", {Title = "Auto Farm Bone", Default = _G.Settings.Farm["Auto Farm Bone"], Callback = function(value)
	...
	FarmTab:AddToggle("TG12", {Title = "Auto Random Surprise", Default = _G.Settings.Farm["Auto Random Surprise"], Callback = function(value)
	...
	FarmTab:AddParagraph({Title = "── Pirate Raid ──"})
	FarmTab:AddToggle("TG13", {Title = "Auto Pirate Raid", Default = _G.Settings.Farm["Auto Pirate Raid"], Callback = function(value)
...
FarmTab:AddParagraph({Title = "── Observation ──"})
...
FarmTab:AddToggle("TG14", {Title = "Auto Farm Observation", Default = _G.Settings.Farm["Auto Farm Observation"], Callback = function(value)
	_G.Settings.Farm["Auto Farm Observation"] = value;
	StopTween(_G.Settings.Farm["Auto Farm Observation"]);
	(getgenv()).SaveSetting();
end});
if World3 then
	FarmTab:AddToggle("TG15", {Title = "Auto V2 Observation", Default = _G.Settings.Farm["Auto Observation V2"], Callback = function(value)
			...
			while wait(0.2) do
				if _G.Settings.Farm["Auto Farm Observation"] then
					if (game:GetService("Players")).LocalPlayer.VisionRadius.Value >= 5000 then
						Fluent:Notify({Title = "Thông báo", Content = "You Have Max Points", Duration = 3});
						wait(2);
					elseif World2 then
...
if World1 then
	FarmTab:AddToggle("TG16", {Title = "Auto Get Saber", Default = _G.Settings.Farm["Auto Saber"], Callback = function(value)
...
FarmTab:AddParagraph({Title = "── Chest Farm ──"})
FarmTab:AddToggle("TG17", {Title = "Auto Farm Chest [ Tween ]", Default = _G.Settings.Farm["Auto Farm Chest Tween"], Callback = function(value)
...
FarmTab:AddToggle("TG18", {Title = "Auto Farm Chest [ Instant ]", Default = _G.Settings.Farm["Auto Farm Chest Instant"], Callback = function(value)
	_G.Settings.Farm["Auto Farm Chest Instant"] = value;
	(getgenv()).SaveSetting();
end});
FarmTab:AddToggle("TG19", {Title = "Auto Chest Hop", Default = _G.Settings.Farm["Auto Chest Hop"], Callback = function(value)
	_G.Settings.Farm["Auto Chest Hop"] = value;
	(getgenv()).SaveSetting();
end});
FarmTab:AddToggle("TG20", {Title = "Auto Stop Items", Default = _G.Settings.Farm["Auto Stop Items"], Callback = function(value)
...
if World2 or World3 then
	FarmTab:AddToggle("TG21", {Title = "Auto Farm Chest Mirage island", Default = _G.Settings.Farm["Auto Farm Chest Mirage"], Callback = function(value)
...
if World3 then
	FarmTab:AddParagraph({Title = "── Cake Farm ──"})
	...
	FarmTab:AddToggle("TG22", {Title = "Auto Katakuri", Default = _G.Settings.Farm["Auto Farm Katakuri"], Callback = function(value)
	...
	FarmTab:AddToggle("TG23", {Title = "Auto Spawn Cake Prince", Default = _G.Settings.Farm["Auto Spawn Cake Prince"], Callback = function(value)
	...
	FarmTab:AddToggle("TG24", {Title = "Auto Kill Cake Prince Only", Default = _G.Settings.Farm["Auto Kill Cake Prince"], Callback = function(value)
	...
	FarmTab:AddToggle("TG25", {Title = "Auto Kill Dough King Only", Default = _G.Settings.Farm["Auto Kill Dough King"], Callback = function(value)
...
SettingsTab:AddParagraph({Title = "── Settings ──"})
SettingsTab:AddToggle("TG26", {Title = "Spin Position", Default = _G.Settings.Setting["Spin Position"], Callback = function(value)
	_G.Settings.Setting["Spin Position"] = value;
	(getgenv()).SaveSetting();
end});
SettingsTab:AddSlider("S8", {Title = "Farm Distnace", Min = 0, Max = 50, Default = _G.Settings.Setting["Farm Distance"], Rounding = 1, Callback = function(value)
	_G.Settings.Setting["Farm Distance"] = value;
	(getgenv()).SaveSetting();
end});
SettingsTab:AddSlider("S9", {Title = "Player Tween Speed", Min = 100, Max = 350, Default = _G.Settings.Setting["Player Tween Speed"], Rounding = 1, Callback = function(value)
	_G.Settings.Setting["Player Tween Speed"] = value;
	(getgenv()).SaveSetting();
end});
SettingsTab:AddToggle("TG27", {Title = "Bring Mob", Default = _G.Settings.Setting["Bring Mob"], Callback = function(value)
...
SettingsTab:AddDropdown("D10", {Title = "BringMob Mode", Values = Bring, Default = _G.Settings.Setting["Bring Mob Mode"], Callback = function(value)
...
SettingsTab:AddToggle("TG28", {Title = "Fast Attack", Default = _G.Settings.Setting["Fast Attack"], Callback = function(value)
...
SettingsTab:AddDropdown("D11", {Title = "Fast Attack Mode", Values = AttackList, Default = _G.Settings.Setting["Fast Attack Mode"], Callback = function(value)
	_G.Settings.Setting["Fast Attack Mode"] = value;
	(getgenv()).SaveSetting();
end});
SettingsTab:AddToggle("TG29", {Title = "Attack Aura", Default = _G.Settings.Setting["Attack Aura"], Callback = function(value)
...
SettingsTab:AddParagraph({Title = "── Graphic ──"})
SettingsTab:AddToggle("TG30", {Title = "Hide Notifications", Default = _G.Settings.Setting["Hide Notification"], Callback = function(value)
...
SettingsTab:AddToggle("TG31", {Title = "Hide Damage Text", Default = _G.Settings.Setting["Hide Damage Text"], Callback = function(value)
...
SettingsTab:AddToggle("TG32", {Title = "Black Screen", Default = _G.Settings.Setting["Black Screen"], Callback = function(value)
...
SettingsTab:AddToggle("TG33", {Title = "White Screen", Default = _G.Settings.Setting["Black Screen"], Callback = function(value)
...
SettingsTab:AddToggle("TG34", {Title = "Hide Monsters", Default = _G.Settings.Setting["Hide Monster"], Callback = function(value)
...
SettingsTab:AddParagraph({Title = "── Mastery Setting ──"})
SettingsTab:AddSlider("S12", {Title = "Kill At %", Min = 1, Max = 100, Default = _G.Settings.Setting["Mastery Health"], Rounding = 1, Callback = function(value)
	_G.Settings.Setting["Mastery Health"] = value;
	(getgenv()).SaveSetting();
end});
SettingsTab:AddParagraph({Title = "Skill DevilFruit"})
SettingsTab:AddToggle("TG35", {Title = "Skill Z", Default = _G.Settings.Setting["Fruit Mastery Skill Z"], Callback = function(value)
	_G.Settings.Setting["Fruit Mastery Skill Z"] = value;
	(getgenv()).SaveSetting();
end});
SettingsTab:AddToggle("TG36", {Title = "Skill X", Default = _G.Settings.Setting["Fruit Mastery Skill X"], Callback = function(value)
	_G.Settings.Setting["Fruit Mastery Skill X"] = value;
	(getgenv()).SaveSetting();
end});
SettingsTab:AddToggle("TG37", {Title = "Skill C", Default = _G.Settings.Setting["Fruit Mastery Skill C"], Callback = function(value)
	_G.Settings.Setting["Fruit Mastery Skill C"] = value;
	(getgenv()).SaveSetting();
end});
SettingsTab:AddToggle("TG38", {Title = "Skill V", Default = _G.Settings.Setting["Fruit Mastery Skill V"], Callback = function(value)
	_G.Settings.Setting["Fruit Mastery Skill V"] = value;
	(getgenv()).SaveSetting();
end});
SettingsTab:AddToggle("TG39", {Title = "Skill F", Default = _G.Settings.Setting["Fruit Mastery Skill F"], Callback = function(value)
	_G.Settings.Setting["Fruit Mastery Skill F"] = value;
	(getgenv()).SaveSetting();
end});
SettingsTab:AddParagraph({Title = "Skill Gun"})
SettingsTab:AddToggle("TG40", {Title = "Skill Z", Default = _G.Settings.Setting["Gun Mastery Skill Z"], Callback = function(value)
	_G.Settings.Setting["Gun Mastery Skill Z"] = value;
	(getgenv()).SaveSetting();
end});
SettingsTab:AddToggle("TG41", {Title = "Skill X", Default = _G.Settings.Setting["Gun Mastery Skill X"], Callback = function(value)
	_G.Settings.Setting["Gun Mastery Skill X"] = value;
	(getgenv()).SaveSetting();
end});
SettingsTab:AddParagraph({Title = "── Other ──"})
SettingsTab:AddToggle("TG42", {Title = "Auto Set Spawn Point", Default = _G.Settings.Setting["Auto Set Spawn Point"], Callback = function(value)
...
SettingsTab:AddToggle("T13", {Title = "Auto Observation", Default = false, Callback = function(value)
...
SettingsTab:AddToggle("TG43", {Title = "Auto Haki", Default = _G.Settings.Setting["Auto Haki"], Callback = function(value)
	_G.Settings.Setting["Auto Haki"] = value;
	(getgenv()).SaveSetting();
end});
SettingsTab:AddToggle("TG44", {Title = "Auto Rejoin", Default = _G.Settings.Setting["Auto Rejoin"], Callback = function(value)
...
SettingsTab:AddToggle("T14", {Title = "Bypass Anti Cheat", Default = true, Callback = function(value)
...
HoldTab:AddParagraph({Title = "── Mastery ──"})
HoldTab:AddSlider("S15", {Title = "Skill Z", Min = 0, Max = 5, Default = _G.Settings.Hold["Hold Mastery Skill Z"], Rounding = 1, Callback = function(value)
	_G.Settings.Hold["Hold Mastery Skill Z"] = value;
	(getgenv()).SaveSetting();
end});
HoldTab:AddSlider("S16", {Title = "Skill X", Min = 0, Max = 5, Default = _G.Settings.Hold["Hold Mastery Skill X"], Rounding = 1, Callback = function(value)
	_G.Settings.Hold["Hold Mastery Skill X"] = value;
	(getgenv()).SaveSetting();
end});
HoldTab:AddSlider("S17", {Title = "Skill C", Min = 0, Max = 5, Default = _G.Settings.Hold["Hold Mastery Skill C"], Rounding = 1, Callback = function(value)
	_G.Settings.Hold["Hold Mastery Skill C"] = value;
	(getgenv()).SaveSetting();
end});
HoldTab:AddSlider("S18", {Title = "Skill V", Min = 0, Max = 5, Default = _G.Settings.Hold["Hold Mastery Skill V"], Rounding = 1, Callback = function(value)
	_G.Settings.Hold["Hold Mastery Skill V"] = value;
	(getgenv()).SaveSetting();
end});
HoldTab:AddSlider("S19", {Title = "Skill F", Min = 0, Max = 5, Default = _G.Settings.Hold["Hold Mastery Skill F"], Rounding = 1, Callback = function(value)
	_G.Settings.Hold["Hold Mastery Skill F"] = value;
	(getgenv()).SaveSetting();
end});
if World3 then
	HoldTab:AddParagraph({Title = "── Sea Event ──"})
	HoldTab:AddSlider("S20", {Title = "Skill Z", Min = 0, Max = 5, Default = _G.Settings.Hold["Hold Sea Skill Z"], Rounding = 1, Callback = function(value)
		_G.Settings.Hold["Hold Sea Skill Z"] = value;
		(getgenv()).SaveSetting();
	end});
	HoldTab:AddSlider("S21", {Title = "Skill X", Min = 0, Max = 5, Default = _G.Settings.Hold["Hold Sea Skill Z"], Rounding = 1, Callback = function(value)
		_G.Settings.Hold["Hold Sea Skill Z"] = value;
		(getgenv()).SaveSetting();
	end});
	HoldTab:AddSlider("S22", {Title = "Skill C", Min = 0, Max = 5, Default = _G.Settings.Hold["Hold Sea Skill C"], Rounding = 1, Callback = function(value)
		_G.Settings.Hold["Hold Sea Skill C"] = value;
		(getgenv()).SaveSetting();
	end});
	HoldTab:AddSlider("S23", {Title = "Skill V", Min = 0, Max = 5, Default = _G.Settings.Hold["Hold Sea Skill V"], Rounding = 1, Callback = function(value)
		_G.Settings.Hold["Hold Sea Skill V"] = value;
		(getgenv()).SaveSetting();
	end});
	HoldTab:AddSlider("S24", {Title = "Skill F", Min = 0, Max = 5, Default = _G.Settings.Hold["Hold Sea Skill F"], Rounding = 1, Callback = function(value)
		_G.Settings.Hold["Hold Sea Skill F"] = value;
		(getgenv()).SaveSetting();
	end});
end;
if World1 or World2 then
	ItemsTab:AddParagraph({Title = "── World ──"})
end;
if World1 then
	ItemsTab:AddToggle("TG45", {Title = "Auto Second Sea", Default = _G.Settings.Items["Auto Second Sea"], Callback = function(value)
...
if World2 then
	ItemsTab:AddToggle("TG46", {Title = "Auto Third Sea", Default = _G.Settings.Items["Auto Third Sea"], Callback = function(value)
...
if World2 then
	ItemsTab:AddToggle("TG47", {Title = "Auto Farm Factory", Default = _G.Settings.Items["Auto Farm Factory"], Callback = function(value)
...
elseif World3 then
	...
	SeaStackTab:AddParagraph({Title = "── Prehistoric Island ──"})
	Prehistoriccheck = SeaStackTab:Label("Prehistoric Island");
	SeaStackTab:AddToggle("TG48", {Title = "Summon Prehistoric Island", Default = _G.Settings.SeaStack["Summon Prehistoric Island"], Callback = function(value)
	...
	SeaStackTab:AddToggle("TG49", {Title = "Tween To Prehistoric Island", Default = _G.Settings.SeaStack["Tween To Prehistoric Island"], Callback = function(value)
	...
	SeaStackTab:AddToggle("TG50", {Title = "Auto Kill Lava Golem", Default = _G.Settings.SeaStack["Auto Kill Lava Golem"], Callback = function(value)
	...
	SeaStackTab:AddParagraph({Title = "── Frozen Dimension ──"})
	Frozencheck = SeaStackTab:Label("Frozen Dimension");
	SeaStackTab:AddToggle("TG51", {Title = "Teleport To Frozen Dimension", Default = _G.Settings.SeaStack["Teleport To Frozen Dimension"], Callback = function(value)
	...
	SeaStackTab:AddToggle("TG52", {Title = "Sail To Frozen Dimension", Default = _G.Settings.SeaStack["Sail To Frozen Dimension"], Callback = function(value)
	...
	SeaStackTab:AddToggle("TG53", {Title = "Summon Frozen Dimension", Default = _G.Settings.SeaStack["Summon Frozen Dimension"], Callback = function(value)
	...
	SeaStackTab:AddButton({Title = "Bribe Leviathan ( Buy Info Leviathan )", Callback = function()
	...
	SeaStackTab:AddParagraph({Title = "── Kitsune Island ──"})
	Kitsunecheck = SeaStackTab:Label("Kitsune Island");
	SeaStackTab:AddToggle("TG54", {Title = "Summon Kitsune Island", Default = _G.Settings.SeaStack["Summon Kitsune Island"], Callback = function(value)
	...
	SeaStackTab:AddToggle("TG55", {Title = "Teleport To Kitsune Island", Default = _G.Settings.SeaStack["Teleport To Kitsune Island"], Callback = function(value)
	...
	SeaStackTab:AddToggle("TG56", {Title = "Auto Collect Azure Ember", Default = _G.Settings.SeaStack["Auto Collect Azure Ember"], Callback = function(value)
	...
	SeaStackTab:AddSlider("S25", {Title = "Set Azure Ember", Min = 10, Max = 25, Default = _G.Settings.SeaStack["Set Azure Ember"], Rounding = 1, Callback = function(value)
		_G.Settings.SeaStack["Set Azure Ember"] = value;
		(getgenv()).SaveSetting();
	end});
	SeaStackTab:AddToggle("TG57", {Title = "Auto Trade Azure Ember", Default = _G.Settings.SeaStack["Auto Trade Azure Ember"], Callback = function(value)
...
if World2 or World3 then
	...
	SeaStackTab:AddParagraph({Title = "── Mirage Island ──"})
	Mirragecheck = SeaStackTab:Label("Mirage Island");
	SeaStackTab:AddToggle("TG58", {Title = "Teleport To Mirage Island", Default = _G.Settings.SeaStack["Teleport To Mirage Island"], Callback = function(value)
		_G.Settings.SeaStack["Teleport To Mirage Island"] = value;
		StopTween(_G.Settings.SeaStack["Teleport To Mirage Island"]);
		(getgenv()).SaveSetting();
	end});
	SeaStackTab:AddToggle("TG59", {Title = "Teleport Advanced Fruit Dealer", Default = _G.Settings.SeaStack["Teleport To Advanced Fruit Dealer"], Callback = function(value)
	...
	if World2 then
		SeaStackTab:AddParagraph({Title = "── Sea Beasts ──"})
		SeaStackTab:AddToggle("TG60", {Title = "Auto Attack Seabeasts", Default = _G.Settings.SeaStack["Auto Attack Seabeasts"], Callback = function(value)
...
if World3 then
	DragonDojoTab:AddParagraph({Title = "── Dragon Dojo ──"})
	...
	DragonDojoTab:AddToggle("TG61", {Title = "Auto Farm Blaze Ember", Default = _G.Settings.DragonDojo["Auto Farm Blaze Ember"], Callback = function(value)
	...
	DragonDojoTab:AddToggle("TG62", {Title = "Auto Collect Blaze Ember", Default = _G.Settings.DragonDojo["Auto Collect Blaze Ember"], Callback = function(value)
	...
	DragonDojoTab:Line();
	DragonDojoTab:AddButton({Title = "Teleport To Dragon Hunter", Callback = function()
	...
	DragonDojoTab:AddButton({Title = "Craft Volcanic Magnet", Callback = function()
		(((game:GetService("ReplicatedStorage")):WaitForChild("Remotes")):WaitForChild("CommF_")):InvokeServer("CraftItem", "Craft", "Volcanic Magnet");
	end});
	CraftTab:AddParagraph({Title = "── Scroll Crafts ──"})
	CraftTab:AddToggle("TG63", {Title = "Auto Craft Common Scroll", Default = _G.Settings.Craft["Auto Craft Common Scroll"], Callback = function(value)
	...
	CraftTab:AddToggle("TG64", {Title = "Auto Craft Rare Scroll", Default = _G.Settings.Craft["Auto Craft Rare Scroll"], Callback = function(value)
	...
	CraftTab:AddToggle("TG65", {Title = "Auto Craft Legendary Scroll", Default = _G.Settings.Craft["Auto Craft Legendary Scroll"], Callback = function(value)
	...
	CraftTab:AddToggle("TG66", {Title = "Auto Craft Mythical Scroll", Default = _G.Settings.Craft["Auto Craft Mythical Scroll"], Callback = function(value)
	...
	CraftTab:AddParagraph({Title = "── Beast Hunter Crafts ──"})
	CraftTab:AddButton({Title = "Craft Leviathan Crown", Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CraftItem", "Craft", "LeviathanCrown");
	end});
	CraftTab:AddButton({Title = "Craft Leviathan Shield", Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CraftItem", "Craft", "LeviathanShield");
	end});
	CraftTab:AddButton({Title = "Craft Beast Hunter", Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CraftItem", "Craft", "BeastHunter");
	end});
	CraftTab:AddParagraph({Title = "── Shark Hunter Crafts ──"})
	CraftTab:AddButton({Title = "Craft Tooth Necklace", Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CraftItem", "Craft", "ToothNecklace");
	end});
	CraftTab:AddButton({Title = "Craft Terror Jaw", Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CraftItem", "Craft", "TerrorJaw");
	end});
	CraftTab:AddButton({Title = "Craft Monster Magnet", Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("CraftItem", "Craft", "MonsterMagnet");
	end});
end;
ItemsTab:AddParagraph({Title = "── Fighting Style ──"})
ItemsTab:AddToggle("TG67", {Title = "Auto Superhuman", Default = _G.Settings.Items["Auto Super Human"], Callback = function(value)
...
ItemsTab:AddToggle("TG68", {Title = "Auto DeathStep", Default = _G.Settings.Items["Auto Death Step"], Callback = function(value)
...
ItemsTab:AddToggle("TG69", {Title = "Auto Sharkman Karate", Default = _G.Settings.Items["Auto Fishman Karate"], Callback = function(value)
...
ItemsTab:AddToggle("TG70", {Title = "Auto Electric Claw", Default = _G.Settings.Items["Auto Electric Claw"], Callback = function(value)
...
ItemsTab:AddToggle("TG71", {Title = "Auto Dragon Talon", Default = _G.Settings.Items["Auto Dragon Talon"], Callback = function(value)
...
ItemsTab:AddToggle("TG72", {Title = "Auto GodHuman", Default = _G.Settings.Items["Auto God Human"], Callback = function(value)
			...
			pcall(function()
				if (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Superhuman") or (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Superhuman") or (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Black Leg") or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Black Leg") or (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Death Step") or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Death Step") or (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Fishman Karate") or (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Sharkman Karate") or (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Electro") or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Electro") or (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Electric Claw") or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Electric Claw") or (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Dragon Claw") or (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Dragon Talon") or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Godhuman") or (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuySuperhuman", true) == 1 then
						...
						Fluent:Notify({Title = "Thông báo", Content = "Not Have Superhuman", Duration = 3});
					end;
					if (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyDeathStep", true) == 1 then
						...
						Fluent:Notify({Title = "Thông báo", Content = "Not Have Death Step", Duration = 3});
					end;
					if (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuySharkmanKarate", true) == 1 then
						...
						Fluent:Notify({Title = "Thông báo", Content = "Not Have Sharkman Karate", Duration = 3});
					end;
					if (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyElectricClaw", true) == 1 then
						...
						Fluent:Notify({Title = "Thông báo", Content = "Not Have Electric Claw", Duration = 3});
					end;
					if (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyDragonTalon", true) == 1 then
						if (game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Dragon Talon") and ((game:GetService("Players")).LocalPlayer.Backpack:FindFirstChild("Dragon Talon")).Level.Value >= 400 or (game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Dragon Talon") and ((game:GetService("Players")).LocalPlayer.Character:FindFirstChild("Dragon Talon")).Level.Value >= 400 then
							if string.find((game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyGodhuman", true), "Bring") then
								Fluent:Notify({Title = "Thông báo", Content = "Not Have Enough Material", Duration = 3});
							else
								(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyGodhuman");
							end;
						end;
					else
						Fluent:Notify({Title = "Thông báo", Content = "Not Have Dragon Talon", Duration = 3});
					end;
				else
					(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuySuperhuman");
				end;
...
FarmTab:AddParagraph({Title = "── Materials ──"})
if World2 then
	FarmTab:AddToggle("TG73", {Title = "Auto Farm Radioactive", Default = _G.Settings.Farm["Auto Farm Radioactive"], Callback = function(value)
...
if World2 then
	FarmTab:AddToggle("TG74", {Title = "Auto Farm Mystic Droplet", Default = _G.Settings.Farm["Auto Farm Mystic Droplet"], Callback = function(value)
...
if World1 or World2 then
	FarmTab:AddToggle("TG75", {Title = "Auto Farm Magma Ore", Default = _G.Settings.Farm["Auto Farm Magma Ore"], Callback = function(value)
...
if World1 then
	FarmTab:AddToggle("TG76", {Title = "Auto Farm Angel Wings", Default = _G.Settings.Farm["Auto Farm Angel Wings"], Callback = function(value)
...
if World1 or World2 or World3 then
	FarmTab:AddToggle("TG77", {Title = "Auto Farm Leather", Default = _G.Settings.Farm["Auto Farm Leather"], Callback = function(value)
...
if World2 then
	FarmTab:AddToggle("TG78", {Title = "Auto Farm Ectoplasm", Default = _G.Settings.Farm["Auto Farm Ectoplasm"], Callback = function(value)
...
if World1 or World2 or World3 then
	FarmTab:AddToggle("TG79", {Title = "Auto Farm Scrap Metal", Default = _G.Settings.Farm["Auto Farm Scrap Metal"], Callback = function(value)
...
if World3 then
	FarmTab:AddToggle("TG80", {Title = "Auto Farm Conjured Cocoa", Default = _G.Settings.Farm["Auto Farm Conjured Cocoa"], Callback = function(value)
...
if World3 then
	FarmTab:AddToggle("TG81", {Title = "Auto Farm Dragon Scale", Default = _G.Settings.Farm["Auto Farm Dragon Scale"], Callback = function(value)
...
if World3 then
	FarmTab:AddToggle("TG82", {Title = "Auto Farm Gunpowder", Default = _G.Settings.Farm["Auto Farm Gunpowder"], Callback = function(value)
...
if World3 then
	FarmTab:AddToggle("TG83", {Title = "Auto Farm Fish Tail", Default = _G.Settings.Farm["Auto Farm Fish Tail"], Callback = function(value)
...
if World3 then
	FarmTab:AddToggle("TG84", {Title = "Auto Farm Mini Tusk", Default = _G.Settings.Farm["Auto Farm Mini Tusk"], Callback = function(value)
...
ItemsTab:AddParagraph({Title = "── Gun & Sword ──"})
if World3 then
	ItemsTab:AddToggle("TG85", {Title = "Auto Buddy Sword", Default = _G.Settings.Items["Auto Buddy Sword"], Callback = function(value)
...
if World3 then
	...
	function GuitarPuzzleProgress()
		if not CommF:InvokeServer("GuitarPuzzleProgress", "Check") then
			if game.Lighting.Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149431" and (game.Lighting.ClockTime > 16 or game.Lighting.ClockTime < 5) then
				...
				Fluent:Notify({Title = "Thông báo", Content = "Hop Full Moon", Duration = 5});
				Hop();
			end;
		else
	...
	function AutoSoulGuitar()
		if (game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("soulGuitarBuy", true) == "[You already own this item.]" then
			Fluent:Notify({Title = "Thông báo", Content = "You already own this item", Duration = 5});
			task.wait(5);
			return;
		end;
		if game.Players.LocalPlayer.Data.Fragments.Value < 5000 then
			task.wait(2);
			Fluent:Notify({Title = "Thông báo", Content = "Need 5000 Fragments", Duration = 5});
			return;
		end;
		if not CheckItemCount("Ectoplasm", 250) then
			task.wait(2);
			Fluent:Notify({Title = "Thông báo", Content = "Need 250 Ectoplasm", Duration = 5});
			return;
		end;
	...
	ItemsTab:AddToggle("TG86", {Title = "Auto Soul Guitar", Default = _G.Settings.Items["Auto Soul Guitar"], Callback = function(value)
...
if World2 then
	ItemsTab:AddToggle("TG87", {Title = "Auto Rengoku", Default = _G.Settings.Items["Auto Rengoku"], Callback = function(value)
...
if World3 then
	ItemsTab:AddToggle("TG88", {Title = "Auto Hallow Scythe", Default = _G.Settings.Items["Auto Hallow Scythe"], Callback = function(value)
...
if World1 then
	ItemsTab:AddToggle("TG89", {Title = "Auto Warden Sword", Default = _G.Settings.Items["Auto Warden Sword"], Callback = function(value)
...
if World3 then
	ItemsTab:AddToggle("TG90", {Title = "Auto Cursed Dual Katana", Default = _G.Settings.Items["Auto Cursed Dual Katana"], Callback = function(value)
		_G.Settings.Items["Auto Cursed Dual Katana"] = value;
		StopTween(_G.Settings.Items["Auto Cursed Dual Katana"]);
		(getgenv()).SaveSetting();
	end});
	ItemsTab:AddToggle("TG91", {Title = "Auto Get Yama", Default = _G.Settings.Items["Auto Yama"], Callback = function(value)
		_G.Settings.Items["Auto Yama"] = value;
		(getgenv()).SaveSetting();
	end});
	ItemsTab:AddToggle("TG92", {Title = "Auto Get Yama Hop", Default = _G.Settings.Items["Auto Yama"], Callback = function(value)
	...
	ItemsTab:AddToggle("TG93", {Title = "Auto Get Tushita", Default = _G.Settings.Items["Auto Tushita"], Callback = function(value)
			...
			if _G.Settings.Items["Auto Tushita"] and World3 then
				pcall(function()
					...
					elseif CheckNameBoss("rip_indra True Form [Lv. 5000] [Raid Boss]") then
						...
						Fluent:Notify({Title = "Thông báo", Content = "Rip Indra Not Spawn", Duration = 2});
						task.wait(3);
					end;
				end);
			end;
	...
	ItemsTab:AddToggle("TG94", {Title = "Auto Canvander", Default = _G.Settings.Items["Auto Canvander"], Callback = function(value)
...
if World3 then
	SeaTab:AddParagraph({Title = "── Sea Event ──"})
	local ListSeaBoat = {
		"Guardian",
		"Beast Hunter",
		"PirateGrandBrigade",
	...
	SeaTab:AddDropdown("D26", {Title = "Choose Boat", Values = ListSeaBoat, Default = _G.Settings.SeaEvent["Selected Boat"], Callback = function(value)
		_G.Settings.SeaEvent["Selected Boat"] = value;
		(getgenv()).SaveSetting();
	end});
	SeaTab:AddDropdown("D27", {Title = "Choose Zone", Values = ListSeaZone, Default = _G.Settings.SeaEvent["Selected Zone"], Callback = function(value)
		_G.Settings.SeaEvent["Selected Zone"] = value;
		(getgenv()).SaveSetting();
	end});
	SeaTab:AddSlider("S28", {Title = "Boat Tween Speed", Min = 100, Max = 350, Default = _G.Settings.SeaEvent["Boat Tween Speed"], Rounding = 1, Callback = function(value)
	...
	SeaTab:AddToggle("TG95", {Title = "Auto Sail Boat", Default = _G.Settings.SeaEvent["Sail Boat"], Callback = function(value)
	...
	SeaTab:AddParagraph({Title = "Enemies"})
	SeaTab:AddToggle("TG96", {Title = "Auto Farm Shark", Default = _G.Settings.SeaEvent["Auto Farm Shark"], Callback = function(value)
		_G.Settings.SeaEvent["Auto Farm Shark"] = value;
		StopTween(_G.Settings.SeaEvent["Auto Farm Shark"]);
		(getgenv()).SaveSetting();
	end});
	SeaTab:AddToggle("TG97", {Title = "Auto Farm Piranha", Default = _G.Settings.SeaEvent["Auto Farm Piranha"], Callback = function(value)
		_G.Settings.SeaEvent["Auto Farm Piranha"] = value;
		StopTween(_G.Settings.SeaEvent["Auto Farm Piranha"]);
		(getgenv()).SaveSetting();
	end});
	SeaTab:AddToggle("TG98", {Title = "Auto Farm Fish Crew Member", Default = _G.Settings.SeaEvent["Auto Farm Fish Crew Member"], Callback = function(value)
		_G.Settings.SeaEvent["Auto Farm Fish Crew Member"] = value;
		StopTween(_G.Settings.SeaEvent["Auto Farm Fish Crew Member"]);
		(getgenv()).SaveSetting();
	end});
	SeaTab:AddParagraph({Title = "Boat"})
	SeaTab:AddToggle("TG99", {Title = "Auto Kill Ghost Ship", Default = _G.Settings.SeaEvent["Auto Farm Ghost Ship"], Callback = function(value)
	...
	SeaTab:AddToggle("TG100", {Title = "Auto Kill Pirate Brigade", Default = _G.Settings.SeaEvent["Auto Farm Pirate Brigade"], Callback = function(value)
		_G.Settings.SeaEvent["Auto Farm Pirate Brigade"] = value;
		StopTween(_G.Settings.SeaEvent["Auto Farm Pirate Brigade"]);
		(getgenv()).SaveSetting();
	end});
	SeaTab:AddToggle("TG101", {Title = "Auto Kill Pirate Grand Brigade", Default = _G.Settings.SeaEvent["Auto Farm Pirate Grand Brigade"], Callback = function(value)
		_G.Settings.SeaEvent["Auto Farm Pirate Grand Brigade"] = value;
		StopTween(_G.Settings.SeaEvent["Auto Farm Pirate Grand Brigade"]);
		(getgenv()).SaveSetting();
	end});
	SeaTab:AddParagraph({Title = "Boss"})
	SeaTab:AddToggle("TG102", {Title = "Auto Kill Terrorshark", Default = _G.Settings.SeaEvent["Auto Farm Terrorshark"], Callback = function(value)
		_G.Settings.SeaEvent["Auto Farm Terrorshark"] = value;
		StopTween(_G.Settings.SeaEvent["Auto Farm Terrorshark"]);
		(getgenv()).SaveSetting();
	end});
	SeaTab:AddToggle("TG103", {Title = "Auto Kill Seabest", Default = _G.Settings.SeaEvent["Auto Farm Seabeasts"], Callback = function(value)
	...
	SeaTab:AddParagraph({Title = "── Ability ──"})
	SeaTab:AddToggle("TG104", {Title = "Lightning", Default = _G.Settings.SeaEvent.Lightning, Callback = function(value)
	...
	SeaTab:AddToggle("TG105", {Title = "Speed Boat", Default = _G.Settings.SeaEvent["Increase Boat Speed"], Callback = function(value)
	...
	SeaTab:AddToggle("TG106", {Title = "No Clip Rock", Default = _G.Settings.SeaEvent["No Clip Rock"], Callback = function(value)
	...
	SettingSeaTab:AddParagraph({Title = "── Settings Sea Event ──"})
	SettingSeaTab:AddToggle("TG107", {Title = "Use Skill Devil Fruit", Default = _G.Settings.SettingSea["Skill Devil Fruit"], Callback = function(value)
		_G.Settings.SettingSea["Skill Devil Fruit"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddToggle("TG108", {Title = "Use Skill Melee", Default = _G.Settings.SettingSea["Skill Melee"], Callback = function(value)
		_G.Settings.SettingSea["Skill Melee"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddToggle("TG109", {Title = "Use Skill Sword", Default = _G.Settings.SettingSea["Skill Sword"], Callback = function(value)
		_G.Settings.SettingSea["Skill Sword"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddToggle("TG110", {Title = "Use Skill Gun", Default = _G.Settings.SettingSea["Skill Gun"], Callback = function(value)
		_G.Settings.SettingSea["Skill Gun"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddParagraph({Title = "[ Skill Fruit ]"})
	SettingSeaTab:AddToggle("TG111", {Title = "Skill Z", Default = _G.Settings.SettingSea["Sea Fruit Skill Z"], Callback = function(value)
		_G.Settings.SettingSea["Sea Fruit Skill Z"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddToggle("TG112", {Title = "Skill X", Default = _G.Settings.SettingSea["Sea Fruit Skill X"], Callback = function(value)
		_G.Settings.SettingSea["Sea Fruit Skill X"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddToggle("TG113", {Title = "Skill C", Default = _G.Settings.SettingSea["Sea Fruit Skill C"], Callback = function(value)
		_G.Settings.SettingSea["Sea Fruit Skill C"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddToggle("TG114", {Title = "Skill V", Default = _G.Settings.SettingSea["Sea Fruit Skill V"], Callback = function(value)
		_G.Settings.SettingSea["Sea Fruit Skill V"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddToggle("TG115", {Title = "Skill F", Default = _G.Settings.SettingSea["Sea Fruit Skill F"], Callback = function(value)
		_G.Settings.SettingSea["Sea Fruit Skill F"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddParagraph({Title = "[ Skill Melee ]"})
	SettingSeaTab:AddToggle("TG116", {Title = "Skill Z", Default = _G.Settings.SettingSea["Sea Melee Skill Z"], Callback = function(value)
		_G.Settings.SettingSea["Sea Melee Skill Z"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddToggle("TG117", {Title = "Skill X", Default = _G.Settings.SettingSea["Sea Fruit Skill X"], Callback = function(value)
		_G.Settings.SettingSea["Sea Fruit Skill X"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddToggle("TG118", {Title = "Skill C", Default = _G.Settings.SettingSea["Sea Fruit Skill C"], Callback = function(value)
		_G.Settings.SettingSea["Sea Fruit Skill C"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddToggle("TG119", {Title = "Skill V", Default = _G.Settings.SettingSea["Sea Fruit Skill V"], Callback = function(value)
		_G.Settings.SettingSea["Sea Fruit Skill V"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddParagraph({Title = "[ Skill Sword ]"})
	SettingSeaTab:AddToggle("TG120", {Title = "Skill Z", Default = _G.Settings.SettingSea["Sea Sword Skill Z"], Callback = function(value)
		_G.Settings.SettingSea["Sea Sword Skill Z"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddToggle("TG121", {Title = "Skill X", Default = _G.Settings.SettingSea["Sea Sword Skill X"], Callback = function(value)
		_G.Settings.SettingSea["Sea Sword Skill X"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddParagraph({Title = "[ Skill Gun ]"})
	SettingSeaTab:AddToggle("TG122", {Title = "Skill Z", Default = _G.Settings.SettingSea["Sea Gun Skill Z"], Callback = function(value)
		_G.Settings.SettingSea["Sea Gun Skill Z"] = value;
		(getgenv()).SaveSetting();
	end});
	SettingSeaTab:AddToggle("TG123", {Title = "Skill X", Default = _G.Settings.SettingSea["Sea Gun Skill X"], Callback = function(value)
...
if World2 then
	ItemsTab:AddToggle("TG124", {Title = "Auto Dragon Trident", Default = _G.Settings.Items["Auto Dragon Trident"], Callback = function(value)
...
if World1 then
	...
	ItemsTab:AddToggle("TG125", {Title = "Auto Pole", Default = _G.Settings.Items["Auto Pole"], Callback = function(value)
		_G.Settings.Items["Auto Pole"] = value;
		StopTween(_G.Settings.Items["Auto Pole"]);
		(getgenv()).SaveSetting();
	end});
	ItemsTab:AddToggle("TG126", {Title = "Auto Shark saw", Default = _G.Settings.Items["Auto Shark Saw"], Callback = function(value)
		_G.Settings.Items["Auto Shark Saw"] = value;
		StopTween(_G.Settings.Items["Auto Shark Saw"]);
		(getgenv()).SaveSetting();
	end});
	ItemsTab:AddToggle("TG127", {Title = "Auto Greybeard", Default = _G.Settings.Items["Auto Greybeard"], Callback = function(value)
...
if World2 then
	ItemsTab:AddToggle("TG128", {Title = "Auto Swan Glasses", Default = _G.Settings.Items["Auto Swan Glasses"], Callback = function(value)
...
if World3 then
	ItemsTab:AddParagraph({Title = "── Other ──"})
	ItemsTab:AddToggle("TG129", {Title = "Auto Arena Trainer", Default = _G.Settings.Items["Auto Arena Trainer"], Callback = function(value)
	...
	ItemsTab:AddToggle("TG130", {Title = "Auto Dark Dagger", Default = _G.Settings.Items["Auto Dark Dagger"], Callback = function(value)
	...
	ItemsTab:AddToggle("TG131", {Title = "Auto Press Haki Button", Default = _G.Settings.Items["Auto Press Haki Button"], Callback = function(value)
	...
	ItemsTab:AddToggle("TG132", {Title = "Auto Rainbow Haki", Default = _G.Settings.Items["Auto Rainbow Haki"], Callback = function(value)
	...
	ItemsTab:AddToggle("TG133", {Title = "Auto Holy Torch", Default = _G.Settings.Items["Auto Holy Torch"], Callback = function(value)
...
if World2 then
	ItemsTab:AddToggle("TG134", {Title = "Auto Bartlio Quest", Default = _G.Settings.Items["Auto Bartilo Quest"], Callback = function(value)
...
StatsTab:AddParagraph({Title = "── Stats ──"})
...
StatsTab:AddToggle("TG135", {Title = "Melee", Default = _G.Settings.Stats["Auto Add Melee Stats"], Callback = function(Value)
	_G.Settings.Stats["Auto Add Melee Stats"] = value;
	(getgenv()).SaveSetting();
end});
StatsTab:AddToggle("TG136", {Title = "Defense", Default = _G.Settings.Stats["Auto Add Defense Stats"], Callback = function(value)
	_G.Settings.Stats["Auto Add Defense Stats"] = value;
	(getgenv()).SaveSetting();
end});
StatsTab:AddToggle("TG137", {Title = "Sword", Default = _G.Settings.Stats["Auto Add Sword Stats"], Callback = function(value)
	_G.Settings.Stats["Auto Add Sword Stats"] = value;
	(getgenv()).SaveSetting();
end});
StatsTab:AddToggle("TG138", {Title = "Gun", Default = _G.Settings.Stats["Auto Add Gun Stats"], Callback = function(value)
	_G.Settings.Stats["Auto Add Gun Stats"] = value;
	(getgenv()).SaveSetting();
end});
StatsTab:AddToggle("TG139", {Title = "Devil Fruit", Default = _G.Settings.Stats["Auto Add Devil Fruit Stats"], Callback = function(value)
	_G.Settings.Stats["Auto Add Devil Fruit Stats"] = value;
	(getgenv()).SaveSetting();
end});
PointStats = 1;
StatsTab:AddSlider("S29", {Title = "Point", Min = 1, Max = 100, Default = PointStats, Rounding = 1, Callback = function(value)
	PointStats = value;
	(getgenv()).SaveSetting();
end});
spawn(function()
...
if World2 then
	RaceV4Tab:AddParagraph({Title = "── Race V2 ──"})
	RaceV4Tab:AddToggle("TG140", {Title = "Auto Evo Race [ V2 ]", Default = _G.Settings.Race["Auto Race V2"], Callback = function(value)
		_G.Settings.Race["Auto Race V2"] = value;
		StopTween(_G.Settings.Race["Auto Race V2"]);
		(getgenv()).SaveSetting();
	end});
	RaceV4Tab:AddToggle("TG141", {Title = "Auto Evo Race [ V3 ]", Default = _G.Settings.Race["Auto Race V3"], Callback = function(value)
...
if World3 then
	RaceV4Tab:AddParagraph({Title = "── Race V4 ──"})
	local PlaceV4List = {
		"Top Of GreatTree",
		"Timple Of Time",
		"Lever Pull",
	...
	RaceV4Tab:AddDropdown("D30", {Title = "Choose Place", Values = PlaceV4List, Default = _G.Settings.Race["Selected PlaceV4"], Callback = function(value)
		_G.Settings.Race["Selected PlaceV4"] = value;
		(getgenv()).SaveSetting();
	end});
	RaceV4Tab:AddToggle("TG142", {Title = "Teleport To Selected Place", Default = _G.Settings.Race["Teleport To PlaceV4"], Callback = function(value)
	...
	RaceV4Tab:AddToggle("TG143", {Title = "Auto Buy Gear", Default = _G.Settings.Race["Auto Buy Gear"], Callback = function(value)
	...
	RaceV4Tab:AddToggle("TG144", {Title = "Tween To Highest Point Mirage Island", Default = _G.Settings.Race["Tween To Highest Mirage"], Callback = function(value)
		_G.Settings.Race["Tween To Highest Mirage"] = value;
		StopTween(_G.Settings.Race["Tween To Highest Mirage"]);
		(getgenv()).SaveSetting();
	end});
	RaceV4Tab:AddToggle("TG145", {Title = "Find Blue Gear", Default = _G.Settings.Race["Find Blue Gear"], Callback = function(value)
		_G.Settings.Race["Find Blue Gear"] = value;
		StopTween(_G.Settings.Race["Find Blue Gear"]);
		(getgenv()).SaveSetting();
	end});
	RaceV4Tab:AddToggle("TG146", {Title = "Auto Look Moon + Use Ability", Default = _G.Settings.Race["Look Moon Ability"], Callback = function(value)
	...
	RaceV4Tab:AddToggle("TG147", {Title = "Auto Train", Default = _G.Settings.Race["Auto Train"], Callback = function(value)
	...
	RaceV4Tab:AddToggle("TG148", {Title = "Disabled Inf Stairs", Default = false, Callback = function(value)
		game.Players.LocalPlayer.Character.InfiniteStairs.Disabled = value;
	end});
	RaceV4Tab:AddButton({Title = "Teleport To Race Door", Callback = function()
		(Game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875);
		wait(0.1);
		(Game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875);
		wait(0.1);
	...
	RaceV4Tab:AddParagraph({Title = "── Auto Complete Trials ──"})
	RaceV4Tab:AddButton({Title = "Buy Ancient One Quest", Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("UpgradeRace", "Buy");
	end});
	RaceV4Tab:AddToggle("TG149", {Title = "Auto Kill Player After Trial", Default = _G.Settings.Race["Auto Kill Player After Trial"], Callback = function(value)
		_G.Settings.Race["Auto Kill Player After Trial"] = value;
		StopTween(_G.Settings.Race["Auto Kill Player After Trial"]);
		(getgenv()).SaveSetting();
	end});
	RaceV4Tab:AddToggle("TG150", {Title = "Auto Trial RaceV4", Default = _G.Settings.Race["Auto Trial"], Callback = function(value)
...
CombatTab:AddParagraph({Title = "── Combat ──"})
...
local SelectedPly = (CombatTab:AddDropdown("DD193", {Title = "Choose Player", Values = Playerslist, Default = false, Callback = function(value)
	_G.SelectedPlayer = value;
end);
CombatTab:AddButton({Title = "Refresh Player", Callback = function()
	Playerslist = {};
	SelectedPly:Clear();
	for i, v in pairs((game:GetService("Players")):GetChildren()) do
...
CombatTab:AddToggle("T31", {Title = "Spectate Player", Default = false, Callback = function(value)
	SpectatePlys = value;
...
CombatTab:AddToggle("T32", {Title = "Teleport To Player", Default = false, Callback = function(value)
...
CombatTab:AddToggle("T33", {Title = "Auto Farm Player", Default = false, Callback = function(value)
...
if World3 then
	CombatTab:AddParagraph({Title = "── Quest Player ──"})
	CombatTab:AddButton({Title = "Get Quest Elite Players", Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("PlayerHunter");
	end});
	CombatTab:AddToggle("TG151", {Title = "Auto Kill Player Quest", Default = _G.Settings.Combat["Auto Kill Player Quest"], Callback = function(value)
...
CombatTab:AddParagraph({Title = "── Aimbot ──"})
spawn(function()
	while wait() do
		pcall(function()
...
CombatTab:AddToggle("TG152", {Title = "Aimbot Gun", Default = _G.Settings.Combat["Aimbot Gun"], Callback = function(value)
...
CombatTab:AddToggle("TG153", {Title = "Aimbot Skill Nearest", Default = _G.Settings.Combat["Aimbot Skill Nearest"], Callback = function(value)
...
CombatTab:AddToggle("TG154", {Title = "Aimbot Skill", Default = _G.Settings.Combat["Aimbot Skill"], Callback = function(value)
...
CombatTab:AddToggle("TG155", {Title = "Enable PvP", Default = _G.Settings.Combat["Enable PvP"], Callback = function(value)
...
CombatTab:AddToggle("T34", {Title = "Safe Mode", Default = false, Callback = function(value)
	_G.Safe_Mode = value;
...
CombatTab:AddButton({Title = "Respawn", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("SetTeam", "Pirates");
end});
if World2 or World3 then
	RaidTab:AddParagraph({Title = "── Dungeon ──"})
	...
	RaidTab:AddDropdown("D35", {Title = "Choose Chip", Values = Raidslist, Default = _G.Settings.Raid["Selected Chip"], Callback = function(value)
	...
	RaidTab:AddToggle("TG156", {Title = "Auto Dungeon ( Fully )", Default = _G.Settings.Raid["Auto Dungeon"], Callback = function(value)
		_G.Settings.Raid["Auto Dungeon"] = value;
		StopTween(_G.Settings.Raid["Auto Dungeon"]);
		(getgenv()).SaveSetting();
	end});
	RaidTab:AddToggle("T36", {Title = "Auto Awaken", Default = false, Callback = function(value)
	...
	RaidTab:AddSlider("S37", {Title = "Price Devil Fruit", Min = 0, Max = 10000000, Default = _G.Settings.Raid["Price Devil Fruit"], Rounding = 1, Callback = function(value)
		_G.Settings.Raid["Price Devil Fruit"] = value;
		(getgenv()).SaveSetting();
	end});
	RaidTab:AddToggle("TG157", {Title = "Auto Unstore Fruit", Default = _G.Settings.Raid["Unstore Devil Fruit"], Callback = function(value)
	...
	RaidTab:AddButton({Title = "Teleport to Lab", Callback = function()
		if World2 then
	...
	if World2 then
		RaidTab:AddParagraph({Title = "── Law Raid ──"})
		RaidTab:AddToggle("TG158", {Title = "Auto Raid Law", Default = _G.Settings.Raid["Law Raid"], Callback = function(value)
...
TeleportTab:AddParagraph({Title = "── World ──"})
TeleportTab:AddButton({Title = "Teleport To First Sea", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("TravelMain");
end});
TeleportTab:AddButton({Title = "Teleport To Second Sea", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("TravelDressrosa");
end});
TeleportTab:AddButton({Title = "Teleport To Third Sea", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("TravelZou");
end});
TeleportTab:AddParagraph({Title = "── Island ──"})
if World1 then
	TeleportTab:AddDropdown("DD301", {Title = "Choose Island", Values = {
		"WindMill",
		"Marine",
		"Middle Town",
		"Jungle",
...
if World2 then
	TeleportTab:AddDropdown("DD302", {Title = "Choose Island", Values = {
		"The Cafe",
		"Frist Spot",
		"Dark Area",
		"Flamingo Mansion",
...
if World3 then
	TeleportTab:AddDropdown("DD303", {Title = "Choose Island", Values = {
		"Mansion",
		"Port Town",
		"Great Tree",
		"Castle On The Sea",
...
TeleportTab:AddToggle("T38", {Title = "Teleport", Default = false, Callback = function(value)
...
TeleportTab:AddParagraph({Title = "── Npc ──"})
if World1 then
	TeleportTab:AddDropdown("DD304", {Title = "Choose NPC", Values = {
		"Random Devil Fruit",
		"Blox Fruits Dealer",
		"Remove Devil Fruit",
		"Ability Teacher",
...
if World2 then
	TeleportTab:AddDropdown("DD305", {Title = "Choose NPC", Values = {
		"Dargon Berath",
		"Mtsterious Man",
...
if World3 then
	TeleportTab:AddDropdown("DD306", {Title = "Choose NPC", Values = {
		"Blox Fruits Dealer",
		"Remove Devil Fruit",
		"Horned Man",
		"Hungey Man",
...
TeleportTab:AddToggle("TG159", {Title = "Teleport", Default = _G.TeleportNPC, Callback = function(value)
...
if World2 then
	ShopTab:AddParagraph({Title = "── Legendary Sword ──"})
	ShopTab:AddToggle("TG160", {Title = "Auto Buy Legendary Sword", Default = _G.Settings.Shop["Auto Buy Legendary Sword"], Callback = function(value)
...
if World2 or World3 then
	ShopTab:AddParagraph({Title = "── Haki Color ──"})
	...
	ShopTab:AddToggle("TG161", {Title = "Auto Buy Haki Color", Default = _G.Settings.Shop["Auto Buy Haki Color"], Callback = function(value)
...
ShopTab:AddParagraph({Title = "── Abilities ──"})
ShopTab:AddButton({Title = "Buy Geppo [ $10,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyHaki", "Geppo");
end});
ShopTab:AddButton({Title = "Buy Buso Haki [ $25,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyHaki", "Buso");
end});
ShopTab:AddButton({Title = "Buy Soru [ $25,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyHaki", "Soru");
end});
ShopTab:AddButton({Title = "Buy Observation Haki [ $750,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("KenTalk", "Buy");
end});
ShopTab:AddToggle("T39", {Title = "Auto Buy Abilities", Default = false, Callback = function(t)
	Abilities = t;
	while Abilities do
		wait(0.2);
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyHaki", "Geppo");
...
ShopTab:AddParagraph({Title = "── Boats ──"})
BoatList = {
	"Pirate Sloop",
	"Enforcer",
	"Rocket Boost",
...
ShopTab:AddDropdown("D40", {Title = "Select Boats", Values = BoatList, Default = false, Callback = function(value)
	SelectBoat = value;
end});
ShopTab:AddButton({Title = "Buy Boat", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyBoat", _G.SelectBoat);
end});
ShopTab:AddParagraph({Title = "── Fighting Style ──"})
ShopTab:AddButton({Title = "Buy Black Leg [ $150,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyBlackLeg");
end});
ShopTab:AddButton({Title = "Buy Electro [ $550,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyElectro");
end});
ShopTab:AddButton({Title = "Buy Water Kung Fu [ $750,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyFishmanKarate");
end});
ShopTab:AddButton({Title = "Buy Dragon Claw [ Æ’1,500 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "DragonClaw", "1");
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "DragonClaw", "2");
end});
ShopTab:AddButton({Title = "Buy Superhuman [ $3,000,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuySuperhuman");
end});
ShopTab:AddButton({Title = "Buy Death Step [ Æ’5,000 $5,000,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyDeathStep");
end});
ShopTab:AddButton({Title = "Buy Sharkman Karate [ Æ’5,000 $2,500,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuySharkmanKarate", true);
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuySharkmanKarate");
end});
ShopTab:AddButton({Title = "Buy Electric Claw [ Æ’5,000 $3,000,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyElectricClaw");
end});
ShopTab:AddButton({Title = "Buy Dragon Talon [ Æ’5,000 $3,000,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyDragonTalon");
end});
ShopTab:AddButton({Title = "Buy God Human [ Æ’5,000 $5,000,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyGodhuman");
end});
ShopTab:AddButton({Title = "Buy Sanguine Art [ Æ’5,000 $5,000,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuySanguineArt", true);
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuySanguineArt");
end});
ShopTab:AddParagraph({Title = "── Sword ──"})
ShopTab:AddButton({Title = "Cutlass [ $1,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Cutlass");
end});
ShopTab:AddButton({Title = "Katana [ $1,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Katana");
end});
ShopTab:AddButton({Title = "Iron Mace [ $25,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Iron Mace");
end});
ShopTab:AddButton({Title = "Dual Katana [ $12,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Duel Katana");
end});
ShopTab:AddButton({Title = "Triple Katana [ $60,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Triple Katana");
end});
ShopTab:AddButton({Title = "Pipe [ $100,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Pipe");
end});
ShopTab:AddButton({Title = "Dual-Headed Blade [ $400,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Dual-Headed Blade");
end});
ShopTab:AddButton({Title = "Bisento [ $1,200,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Bisento");
end});
ShopTab:AddButton({Title = "Soul Cane [ $750,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Soul Cane");
end});
ShopTab:AddButton({Title = "Pole v.2 [ Æ’5,000 ]", Callback = function()
	game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ThunderGodTalk");
end});
ShopTab:AddParagraph({Title = "── Gun ──"})
ShopTab:AddButton({Title = "Slingshot [ $5,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Slingshot");
end});
ShopTab:AddButton({Title = "Musket [ $8,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Musket");
end});
ShopTab:AddButton({Title = "Flintlock [ $10,500 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Flintlock");
end});
ShopTab:AddButton({Title = "Refined Slingshot [ $30,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Refined Flintlock");
end});
ShopTab:AddButton({Title = "Refined Flintlock [ $65,000 ]", Callback = function()
	local args = {
		[1] = "BuyItem",
		[2] = "Refined Flintlock"
	};
...
ShopTab:AddButton({Title = "Cannon [ $100,000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BuyItem", "Cannon");
end});
ShopTab:AddButton({Title = "Kabucha [ Æ’1,500]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Slingshot", "1");
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Slingshot", "2");
end});
ShopTab:AddButton({Title = "Bizarre Rifle [ 250 Ectoplasm ]", Callback = function()
	local A_1 = "Ectoplasm";
	local A_2 = "Buy";
	local A_3 = 1;
...
ShopTab:AddParagraph({Title = "── Stats ──"})
ShopTab:AddButton({Title = "Reset Stats [ Use Æ’2,500 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Refund", "1");
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Refund", "2");
end});
ShopTab:AddButton({Title = "Random Race [ Use Æ’3000 ]", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Reroll", "1");
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("BlackbeardReward", "Reroll", "2");
end});
ShopTab:AddParagraph({Title = "── Accessories ──"})
ShopTab:AddButton({Title = "Black Cape [ $50,000 ]", Callback = function()
	local args = {
		[1] = "BuyItem",
		[2] = "Black Cape"
	};
...
ShopTab:AddButton({Title = "Swordsman Hat [ $150,000 ]", Callback = function()
	local args = {
		[1] = "BuyItem",
		[2] = "Swordsman Hat"
	};
...
ShopTab:AddButton({Title = "Tomoe Ring [ $500,000 ]", Callback = function()
	local args = {
		[1] = "BuyItem",
		[2] = "Tomoe Ring"
	};
...
FruitTab:AddParagraph({Title = "── Fruits ──"})
FruitTab:AddToggle("TG162", {Title = "Auto Random Fruit", Default = _G.Settings.Fruit["Auto Buy Random Fruit"], Callback = function(value)
...
FruitTab:AddButton({Title = "Random Fruit", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("Cousin", "Buy");
end});
FruitTab:AddButton({Title = "Open Devil Shop", Callback = function()
...
FruitTab:AddDropdown("D41", {Title = "Store Rarity Fruit", Values = SelectRarityFruits, Default = _G.Settings.Fruit["Store Rarity Fruit"], Callback = function(value)
...
FruitTab:AddToggle("TG163", {Title = "Auto Store Fruit", Default = _G.Settings.Fruit["Auto Store Fruit"], Callback = function(value)
...
FruitTab:AddToggle("TG164", {Title = "Fruit Notification", Default = _G.Settings.Fruit["Fruit Notification"], Callback = function(value)
...
spawn(function()
	while wait(2) do
		if _G.Settings.Fruit["Fruit Notification"] then
			for i, v in pairs(game.Workspace:GetChildren()) do
				if string.find(v.Name, "Fruit") then
					Fluent:Notify({Title = "Thông báo", Content = tostring("Fruit : " .. v.Nmae), Duration = 3});
				end;
			end;
		end;
	end;
end});
FruitTab:AddToggle("TG165", {Title = "Teleport To Fruit", Default = _G.Settings.Fruit["Teleport To Fruit"], Callback = function(value)
...
FruitTab:AddToggle("TG166", {Title = "Tween To Fruit", Default = _G.Settings.Fruit["Tween To Fruit"], Callback = function(value)
...
FruitTab:AddButton({Title = "Grab All Fruits", Callback = function()
	for i, v in pairs(game.Workspace:GetChildren()) do
		if v:IsA("Tool") then
...
FruitTab:AddParagraph({Title = "── Visual ──"})
FruitTab:AddButton({Title = "Rain Fruit", Callback = function()
...
MiscTab:AddParagraph({Title = "── Misc ──"})
MiscTab:AddButton({Title = "Open Devil Shop", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("GetFruits");
	(game:GetService("Players")).LocalPlayer.PlayerGui.Main.FruitShop.Visible = true;
end});
MiscTab:AddButton({Title = "Open Haki Color", Callback = function()
	game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true;
end});
MiscTab:AddButton({Title = "Open Title Name", Callback = function()
	local args = {
		[1] = "getTitles"
	};
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer(unpack(args));
...
MiscTab:AddButton({Title = "Open Inventory", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("getInventoryWeapons");
	wait(1);
	(game:GetService("Players")).LocalPlayer.PlayerGui.Main.Inventory.Visible = true;
end});
MiscTab:AddButton({Title = "Open Inventory Fruit", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("getInventoryFruits");
	(game:GetService("Players")).LocalPlayer.PlayerGui.Main.FruitInventory.Visible = true;
end});
MiscTab:AddParagraph({Title = "── Teams ──"})
MiscTab:AddButton({Title = "Join Pirates Team", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("SetTeam", "Pirates");
end});
MiscTab:AddButton({Title = "Join Marines Team", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("SetTeam", "Marines");
end});
MiscTab:AddParagraph({Title = "── Highlight ──"})
MiscTab:AddToggle("TG167", {Title = "Hide Chat", Default = _G.Settings.Misc["Hide Chat"], Callback = function(value)
...
MiscTab:AddToggle("TG168", {Title = "Hide Leaderboard", Default = _G.Settings.Misc["Hide Leaderboard"], Callback = function(value)
...
MiscTab:AddToggle("T42", {Title = "Highlight Mode", Default = false, Callback = function(value)
	_G.Settings.Misc["Highlight Mode"] = value;
end});
MiscTab:AddParagraph({Title = "── Codes ──"})
local x2Code = {
	"KITTGAMING",
	"ENYU_IS_PRO",
	"FUDD10",
...
MiscTab:AddButton({Title = "Redeem All Codes", Callback = function()
...
MiscTab:AddDropdown("DD307", {Title = "Select Codes", Values = {
	"NOOB_REFUND",
...
MiscTab:AddButton({Title = "Redeem Code", Callback = function()
	(game:GetService("ReplicatedStorage")).Remotes.Redeem:InvokeServer(_G.CodeSelect);
end});
MiscTab:AddParagraph({Title = "── Graphic ──"})
MiscTab:AddButton({Title = "FPS Boost", Callback = function()
...
MiscTab:AddButton({Title = "Remove Fog", Callback = function()
	(game:GetService("Lighting")).LightingLayers:Destroy();
	(game:GetService("Lighting")).Sky:Destroy();
	game.Lighting.FogEnd = 9000000000;
end});
MiscTab:AddButton({Title = "Remove Lava", Callback = function()
...
EspTab:AddParagraph({Title = "── ESP ──"})
EspTab:AddToggle("TG169", {Title = "ESP Player", Default = _G.Settings.Esp["ESP Player"], Callback = function(value)
	_G.Settings.Esp["ESP Player"] = value;
	(getgenv()).SaveSetting();
end});
EspTab:AddToggle("TG170", {Title = "ESP Chest", Default = _G.Settings.Esp["ESP Chest"], Callback = function(value)
	_G.Settings.Esp["ESP Chest"] = value;
	(getgenv()).SaveSetting();
end});
EspTab:AddToggle("TG171", {Title = "ESP Fruit", Default = _G.Settings.Esp["ESP DevilFruit"], Callback = function(value)
	_G.Settings.Esp["ESP DevilFruit"] = value;
	(getgenv()).SaveSetting();
end});
if World3 then
	EspTab:AddToggle("TG172", {Title = "ESP Real Fruit", Default = _G.Settings.Esp["ESP RealFruit"], Callback = function(value)
		_G.Settings.Esp["ESP RealFruit"] = value;
		(getgenv()).SaveSetting();
	end});
end;
if World2 then
	EspTab:AddToggle("TG173", {Title = "ESP Flower", Default = _G.Settings.Esp["ESP Flower"], Callback = function(value)
		_G.Settings.Esp["ESP Flower"] = value;
		(getgenv()).SaveSetting();
	end});
end;
EspTab:AddToggle("TG174", {Title = "ESP Island", Default = _G.Settings.Esp["ESP Island"], Callback = function(value)
	_G.Settings.Esp["ESP Island"] = value;
	(getgenv()).SaveSetting();
end});
EspTab:AddToggle("TG175", {Title = "ESP Npc", Default = _G.Settings.Esp["ESP Npc"], Callback = function(value)
	_G.Settings.Esp["ESP Npc"] = value;
	(getgenv()).SaveSetting();
end});
if World2 or World3 then
	EspTab:AddToggle("TG176", {Title = "Esp Sea Beast", Default = _G.Settings.Esp["ESP Sea Beast"], Callback = function(value)
		_G.Settings.Esp["ESP Sea Beast"] = value;
		(getgenv()).SaveSetting();
	end});
end;
EspTab:AddToggle("TG177", {Title = "Esp Monster", Default = _G.Settings.Esp["ESP Monster"], Callback = function(value)
	_G.Settings.Esp["ESP Monster"] = value;
	(getgenv()).SaveSetting();
end});
if World2 or World3 then
	EspTab:AddToggle("TG178", {Title = "Esp Mirage Island", Default = _G.Settings.Esp["ESP Mirage"], Callback = function(value)
		_G.Settings.Esp["ESP Mirage"] = value;
		(getgenv()).SaveSetting();
	end});
end;
if World3 then
	EspTab:AddToggle("TG179", {Title = "Esp Kitsune Island", Default = _G.Settings.Esp["ESP Kitsune"], Callback = function(value)
		_G.Settings.Esp["ESP Kitsune"] = value;
		(getgenv()).SaveSetting();
	end});
	EspTab:AddToggle("TG180", {Title = "Esp Frozen Dimension", Default = _G.Settings.Esp["ESP Frozen"], Callback = function(value)
		_G.Settings.Esp["ESP Frozen"] = value;
		(getgenv()).SaveSetting();
	end});
	EspTab:AddToggle("TG181", {Title = "Esp Prehistoric Island", Default = _G.Settings.Esp["ESP Prehistoric"], Callback = function(value)
		_G.Settings.Esp["ESP Frozen"] = value;
		(getgenv()).SaveSetting();
	end});
	EspTab:AddToggle("TG182", {Title = "Esp Advanced Fruit Dealer", Default = _G.Settings.Esp["ESP Fruit Dealer"], Callback = function(value)
		_G.Settings.Esp["ESP Fruit Dealer"] = value;
		(getgenv()).SaveSetting();
	end});
	EspTab:AddToggle("TG183", {Title = "Esp Gear", Default = _G.Settings.Esp["ESP Gear"], Callback = function(value)
		_G.Settings.Esp["ESP Gear"] = value;
		(getgenv()).SaveSetting();
	end});
end;
LocalPlayerTab:AddParagraph({Title = "── Local Player ──"})
LocalPlayerTab:AddToggle("TG184", {Title = "Dodge No Cooldown", Default = _G.Settings.LocalPlayer["Dodge No Cooldown"], Callback = function(value)
	_G.Settings.LocalPlayer["Dodge No Cooldown"] = value;
	(getgenv()).SaveSetting();
end});
LocalPlayerTab:AddToggle("TG185", {Title = "Infinite Energy", Default = _G.Settings.LocalPlayer["Infinite Energy"], Callback = function(value)
	_G.Settings.LocalPlayer["Infinite Energy"] = value;
	(getgenv()).SaveSetting();
end});
LocalPlayerTab:AddToggle("TG186", {Title = "Auto Active Race V3", Default = _G.Settings.LocalPlayer["Active Race V3"], Callback = function(value)
	_G.Settings.LocalPlayer["Active Race V3"] = value;
	(getgenv()).SaveSetting();
end});
LocalPlayerTab:AddToggle("TG187", {Title = "Auto Active Race V4", Default = _G.Settings.LocalPlayer["Active Race V4"], Callback = function(value)
...
LocalPlayerTab:AddToggle("TG188", {Title = "Infinite Ability", Default = _G.Settings.LocalPlayer["Infinite Ability"], Callback = function(value)
...
LocalPlayerTab:AddToggle("TG189", {Title = "Infinite Geppo", Default = _G.Settings.LocalPlayer["Infinite Geppo"], Callback = function(value)
...
LocalPlayerTab:AddToggle("TG190", {Title = "Infinite Soru", Default = _G.Settings.LocalPlayer["Infinite Soru"], Callback = function(value)
...
LocalPlayerTab:AddToggle("TG191", {Title = "Walk on Water", Default = _G.Settings.LocalPlayer["Walk On Water"], Callback = function(value)
...
LocalPlayerTab:AddToggle("TG192", {Title = "NoClip", Default = _G.Settings.LocalPlayer["No Clip"], Callback = function(value)
...
ServTab:AddParagraph({Title = "── Server ──"})
task.spawn(function()
	while task.wait() do
		pcall(function()
...
ServTab:AddButton({Title = "Rejoin Server", Callback = function()
	(game:GetService("TeleportService")):Teleport(game.PlaceId, (game:GetService("Players")).LocalPlayer);
end});
ServTab:AddButton({Title = "Server Hop", Callback = function()
	while wait(0.2) do
		local module = (loadstring(game:HttpGet("https://roblox.farrghii.com/Hop.lua")))();
		module:Teleport(game.PlaceId, "Singapore");
	end;
end});
ServTab:AddButton({Title = "Hop Lower Player", Callback = function()
	local module = (loadstring(game:HttpGet("https://raw.githubusercontent.com/raw-scriptpastebin/FE/main/Server_Hop_Settings")))();
	module:Teleport(game.PlaceId);
end});
spawn(function()
...
ServTab:AddButton({Title = "Copy Server Job ID", Callback = function()
...
ServTab:AddParagraph({Title = "── Advance Fruit Stock ──"})
...
ServTab:AddParagraph({Title = "── Normal Fruit Stock ──"})

...
-- ╔══════════════════════════════════════════════════════════════╗
-- ║                    ⚙  USER CONFIG                           ║
-- ║         Chỉ chỉnh sửa phần này — DO NOT TOUCH BELOW        ║
-- ╚══════════════════════════════════════════════════════════════╝
getgenv().Config = {

    -- ── FRUIT ────────────────────────────────────────────────────
    -- Fruit bạn đang dùng trong game
    -- Các giá trị hợp lệ: "T-Rex", "Dragon", "Kitsune",
    --                      "Empyrean", "Pain", "Control", "Mammoth"
    Fruit = "T-Rex",

    -- ── REGION ───────────────────────────────────────────────────
    -- Server region để farm (chọn gần bạn nhất để ping thấp)
    -- Các giá trị hợp lệ: "Brazil", "Japan", "Singapore",
    --   "Hong Kong", "India", "Australia", "Germany", "Netherlands",
    --   "Poland", "California", "Oregon", "Virginia", "Miami", "Texas"
    Region = "Singapore",

    -- ── FACTION ──────────────────────────────────────────────────
    -- Phe bạn muốn chơi
    -- Các giá trị hợp lệ: "Auto", "Pirate", "Marine"
    Faction = "Pirate",

    -- ── WEBHOOK ──────────────────────────────────────────────────
    -- Discord webhook để nhận thông báo kill (để trống nếu không dùng)
    -- Ví dụ: "https://discord.com/api/webhooks/..."
    Webhook = "",

    -- ── TEAM SWAP ────────────────────────────────────────────────
    -- Tự đổi phe khi Bounty/Honor đạt 30M
    ChangeTeamAt30M = true,

    -- Thoát Roblox khi đạt 30M (tránh bị ban)
    AutoKillAt30M = true,

    -- ── T-REX TRANSFORM ──────────────────────────────────────────
    -- Tự transform T-Rex khi Rage sẵn sàng
    TransformTRex = true,

    -- ── SOUND ────────────────────────────────────────────────────
    -- Phát âm thanh bankai khi dùng v4/awakening
    StartupSound = true,

    -- URL âm thanh tùy chỉnh (mp3/ogg), để trống = dùng mặc định
    SoundUrl = "",

    -- ── UI ───────────────────────────────────────────────────────
    -- Ẩn tên/avatar của bạn trên giao diện
    HideProfile = false,

    -- URL ảnh nền tùy chỉnh cho UI (png/webp), để trống = mặc định
    Background = "",
}
-- ╚══════════════════════════════════════════════════════════════╝
--          ↑↑↑  CHỈ SỬA ĐẾN ĐÂY  ↑↑↑  DO NOT EDIT BELOW  ↑↑↑
-- ╚══════════════════════════════════════════════════════════════╝
...
_modules["config"] = function()
    ...
    function Config.isConfigured()
        -- If user provided config via getgenv().Config, always considered configured
